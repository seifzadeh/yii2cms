...
<div class="panel panel-default">
  <div class="panel-heading"><?=Yii::t('app', 'Youre Comment')?></div>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title"><?=Yii::t('app', 'All comments')?></h3>
  </div>
  <div class="panel-body">
   <?php
...
foreach ($comment as $k => $v) {
  ...
  <div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title"><a href="<?=$v['url']?>"><?=$v['author']?></a> - <?php echo date('Y/m/d H:i', $v['create_time'])?></h3>
  </div>
  <div class="panel-body">
<?=$v['content']?>
